...
var jackpots = [{
  ...
  "Items": [{
    ...
    "TotalLines": 10,
    "PickedNumbers": [{
      "BasePick": ["10", "22", "30", "37", "40"],
      "ExtraPick": ["3", "4"]
    }, {
      "BasePick": ["2", "11", "24", "37", "40"],
      "ExtraPick": ["1", "6"]
    }, {
      "BasePick": ["24", "29", "39", "45", "47"],
      "ExtraPick": ["11", "12"]
    }, {
      "BasePick": ["3", "11", "19", "30", "43"],
      "ExtraPick": ["3", "12"]
    }, {
      "BasePick": ["6", "18", "25", "33", "38"],
      "ExtraPick": ["6", "9"]
    }, {
      "BasePick": ["10", "15", "20", "25", "35"],
      "ExtraPick": ["1", "9"]
    }, {
      "BasePick": ["2", "34", "36", "39", "45"],
      "ExtraPick": ["9", "12"]
    }, {
      "BasePick": ["10", "13", "22", "25", "35"],
      "ExtraPick": ["5", "7"]
    }, {
      "BasePick": ["2", "6", "12", "25", "44"],
      "ExtraPick": ["2", "6"]
    }, {
      "BasePick": ["10", "22", "32", "37", "50"],
      "ExtraPick": ["8", "9"]
    }],
    "LotteryLink": "eumillions",
    "jackpotAsStringRounded": ["74", " Million"],
    "jackpotAsString": ["74.0", " million"],
    "currency": "€"
  }]
}, {
  "PackageID": 572,
  ...
  "Items": [{
    ...
    "TotalLines": 6,
    "PickedNumbers": [{
      "BasePick": ["13", "22", "31", "34", "47"],
      "ExtraPick": ["2", "9"]
    }, {
      "BasePick": ["8", "12", "23", "25", "32"],
      "ExtraPick": ["3", "9"]
    }, {
      "BasePick": ["3", "11", "12", "37", "49"],
      "ExtraPick": ["3", "5"]
    }, {
      "BasePick": ["10", "11", "17", "43", "49"],
      "ExtraPick": ["2", "4"]
    }, {
      "BasePick": ["15", "27", "30", "35", "43"],
      "ExtraPick": ["7", "10"]
    }, {
      "BasePick": ["18", "25", "40", "42", "46"],
      "ExtraPick": ["4", "9"]
    }],
    "LotteryLink": "eurojackpot",
    "jackpotAsStringRounded": ["10", " Million"],
    "jackpotAsString": ["10.0", " million"],
    "currency": "€"
  }]
}, {
  "PackageID": 200,
  ...
  "Items": [{
    ...
    "TotalLines": 6,
    "PickedNumbers": [{
      "BasePick": ["11", "13", "51", "67", "68"],
      "ExtraPick": ["1"]
    }, {
      "BasePick": ["2", "3", "36", "56", "59"],
      "ExtraPick": ["17"]
    }, {
      "BasePick": ["13", "16", "45", "53", "67"],
      "ExtraPick": ["16"]
    }, {
      "BasePick": ["4", "47", "48", "58", "60"],
      "ExtraPick": ["22"]
    }, {
      "BasePick": ["5", "23", "24", "49", "54"],
      "ExtraPick": ["23"]
    }, {
      "BasePick": ["37", "53", "55", "60", "65"],
      "ExtraPick": ["2"]
    }],
    "LotteryLink": "megamillions",
    "jackpotAsStringRounded": ["84.2", " Million"],
    "jackpotAsString": ["84.2", " million"],
    "currency": "€"
  }]
}];
...
function () {
  ...
  _createClass(myApp, [{
    key: "prepareElement",
    value: function prepareElement(obj) {
      var item = "<div class=\"jackpot_wrapper\">\n            <button type=\"button\" class=\"delete_wrapper\" data-id=".concat(obj.PackageID, ">x</button>\n            <div class=\"jackpot_name\">").concat(obj.DisplayName, "</div>\n            <div class=\"jackpot_price\">Price: ").concat(obj.PackagePrice, "</div>\n            <div class=\"jackpot_amount\">Jackpot: ").concat(obj.Items[0].JackpotAmount, "</div>\n        </div>");
      return item;
    }
  }, {
    key: "getData",
    value: function getData() {
      var elements = this.obj.map(this.prepareElement).join('');
      return elements;
    }
  }, {
    key: "pushData",
    value: function pushData() {
      var parent = document.getElementById('objects_holder');
    ...
    value: function priceSort() {
      if (!this.priceAsc) {
        this.obj = this.obj.sort(function (a, b) {
    ...
    value: function removeElement(id) {
      this.obj = this.obj.filter(function (element) {
        return parseInt(element.PackageID) != parseInt(id);
      });
      this.pushData();
    }
  }, {
    ...
    value: function run() {
      ...
      document.getElementById('objects_holder').addEventListener('click', function (e) {
        if (e.target.classList.contains('delete_wrapper')) {
          _this.removeElement(e.target.getAttribute('data-id'));
        }
      });
    }
  }]);
